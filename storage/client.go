...
//GetQueueService retuns a QUeueStorageClient which can operate on the
// queue service of the storage account.
func (c StorageClient) GetQueueService() *QueueStorageClient {
	return &QueueStorageClient{c}
}
